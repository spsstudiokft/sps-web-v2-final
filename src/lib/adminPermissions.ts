...
export const ADMIN_MENU_PERMISSIONS: AdminMenuPermission[] = [
  ...
  { id: "budget", label: "Budget manager", description: "Budget entries and financial reports", defaultRoles: ["admin", "editor"], matches: (path, search) => path === "/admin/budget" && !search.includes("tab=invoices") && !search.includes("tab=payment-requests") },
