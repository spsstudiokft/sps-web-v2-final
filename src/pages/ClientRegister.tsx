              ...
              <div className="space-y-1.5">
                {!showReferralInput ? (
                  <button
                    ...
                    className="group w-full rounded-xl border border-amber-400/45 bg-gradient-to-r from-amber-500/15 via-primary/10 to-indigo-500/15 p-3 text-left transition-all hover:border-amber-400/70 hover:shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/60"
                  >
                  ...
                  <div className="p-3 rounded-xl bg-gradient-to-r from-amber-500/10 via-primary/5 to-transparent border border-amber-400/40 space-y-1.5">
                    <Label htmlFor="referral_code" className="text-xs font-medium flex items-center justify-between">
                      <span className="flex items-center gap-1.5">
                        <Gift className="w-3.5 h-3.5 text-amber-600 dark:text-amber-300" />
