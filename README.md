...
- **Origin-Isolated PWAs**: Admin, Client Portal, and Property Manager installations launch from dedicated `admin`, `client`, and `property` subdomains, isolating browser storage, service workers, and offline caches on Android and desktop browsers. See [`docs/PWA_SUBDOMAIN_CLOUDFLARE_SETUP.md`](docs/PWA_SUBDOMAIN_CLOUDFLARE_SETUP.md).
